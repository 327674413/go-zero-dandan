...
type SendPhoneAsyncLogicGen struct {
	ctx  context.Context
...
func NewSendPhoneAsyncLogicGen(ctx context.Context, svc *svc.ServiceContext) *SendPhoneAsyncLogicGen {
	meta, _ := ctx.Value("reqMeta").(*typed.ReqMeta)
	if meta == nil {
		meta = &typed.ReqMeta{}
	}
	return &SendPhoneAsyncLogicGen{
		ctx:    ctx,
		svc:    svc,
...
func (l *SendPhoneAsyncLogicGen) initReq(req *messageRpc.SendPhoneReq) error {
