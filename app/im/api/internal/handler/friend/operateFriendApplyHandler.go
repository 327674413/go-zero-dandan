...
func OperateFriendApplyHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.OperateFriendApplyReq
		if err := httpx.Parse(r, &req); err != nil {
			httpx.OkJsonCtx(r.Context(), w, resd.Error(err))
			return
		}

		l := friend.NewOperateFriendApplyLogic(r.Context(), svcCtx)
		resp, err := l.OperateFriendApply(&req)
		if err != nil {
