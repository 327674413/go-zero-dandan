...
type ChatLog struct {
	...
	SendId         int64  `protobuf:"varint,3,opt,name=sendId,proto3" json:"sendId,omitempty"`
	RecvId         int64  `protobuf:"varint,4,opt,name=recvId,proto3" json:"recvId,omitempty"`
...
func (x *ChatLog) GetSendId() int64 {
	if x != nil {
		return x.SendId
	}
	return 0
...
func (x *ChatLog) GetRecvId() int64 {
	if x != nil {
		return x.RecvId
	}
	return 0
...
func (x *PutConversationsReq) GetUserId() int64 {
	if x != nil {
		return x.UserId
	}
	return 0
...
func (x *SetUpUserConversationReq) GetSendId() int64 {
	if x != nil {
		return x.SendId
	}
	return 0
...
func (x *SetUpUserConversationReq) GetRecvId() int64 {
	if x != nil {
		return x.RecvId
	}
	return 0
...
type CreateGroupConversationReq struct {
	...
	CreateId int64 `protobuf:"varint,2,opt,name=CreateId,proto3" json:"CreateId,omitempty"`
}
...
func (x *CreateGroupConversationReq) GetGroupId() int64 {
	if x != nil {
		return x.GroupId
	}
	return 0
...
func (x *CreateGroupConversationReq) GetCreateId() int64 {
	if x != nil {
		return x.CreateId
	}
	return 0
...
var file_im_proto_rawDesc = []byte{
	...
	0x28, 0x03, 0x52, 0x06, 0x73, 0x65, 0x6e, 0x64, 0x49, 0x64, 0x12, 0x16, 0x0a, 0x06, 0x72, 0x65,
	0x63, 0x76, 0x49, 0x64, 0x18, 0x04, 0x20, 0x01, 0x28, 0x03, 0x52, 0x06, 0x72, 0x65, 0x63, 0x76,
	...
	0x12, 0x0a, 0x04, 0x52, 0x65, 0x61, 0x64, 0x18, 0x09, 0x20, 0x01, 0x28, 0x03, 0x52, 0x04, 0x52,
	...
	0x02, 0x20, 0x01, 0x28, 0x03, 0x52, 0x06, 0x75, 0x73, 0x65, 0x72, 0x49, 0x64, 0x12, 0x59, 0x0a,
	...
	0x20, 0x01, 0x28, 0x03, 0x52, 0x06, 0x53, 0x65, 0x6e, 0x64, 0x49, 0x64, 0x12, 0x16, 0x0a, 0x06,
	0x72, 0x65, 0x63, 0x76, 0x49, 0x64, 0x18, 0x02, 0x20, 0x01, 0x28, 0x03, 0x52, 0x06, 0x72, 0x65,
	0x63, 0x76, 0x49, 0x64, 0x12, 0x1a, 0x0a, 0x08, 0x63, 0x68, 0x61, 0x74, 0x54, 0x79, 0x70, 0x65,
	0x18, 0x03, 0x20, 0x01, 0x28, 0x03, 0x52, 0x08, 0x63, 0x68, 0x61, 0x74, 0x54, 0x79, 0x70, 0x65,
	...
	0x72, 0x6f, 0x75, 0x70, 0x49, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x03, 0x52, 0x07, 0x47, 0x72,
	0x6f, 0x75, 0x70, 0x49, 0x64, 0x12, 0x1a, 0x0a, 0x08, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x49,
	0x64, 0x18, 0x02, 0x20, 0x01, 0x28, 0x03, 0x52, 0x08, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x49,
